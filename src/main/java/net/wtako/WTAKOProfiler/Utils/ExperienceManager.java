 ...
 *         -giving-taking-exp-a-bit-more-intuitive.54450/#post-1067480)
 ...
 *         See http://forums.bukkit.org/threads/experiencemanager-was-
 *         experienceutils
 *         -make-giving-taking-exp-a-bit-more-intuitive.54450/page
 *         -3#post-1273622
 * 
 */
public class ExperienceManager {
    ...
    public int getLevelForExp(int exp) {
        ...
        if (exp > ExperienceManager.xpTotalToReachLevel[ExperienceManager.xpTotalToReachLevel.length - 1]) {
            ...
            Validate.isTrue(newMax <= ExperienceManager.hardMaxLevel, "Level for exp " + exp + " > hard max level "
                    + ExperienceManager.hardMaxLevel);
    ...
    public int getXpForLevel(int level) {
        Validate.isTrue(level >= 0 && level <= ExperienceManager.hardMaxLevel, "Invalid level " + level
                + "(must be in range 0.." + ExperienceManager.hardMaxLevel + ")");
